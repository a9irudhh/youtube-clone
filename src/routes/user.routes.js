...
router.route("/avatar").patch(verifyJwt, upload.single("avatarPath"), updateUserAvatar) 
router.route("/coverPhoto").patch(verifyJwt, upload.single("coverImagePath"), updateCoverPath)
